...
### Pancake Model Coefficients
m.PMC_D = 1.5		# drag coeff.
m.PMabp = 1.2e-8
m.PMC_L = 1.e-3
m.f_p = 7.1
m.PMincr_strength = 'No' # Increasing strength after fragmentation: 'Yes' or 'No'
m.PMablation_rad = 'No'
m.PMmstrength0 = 9.5e5
m.PMenergy_calc = 'Deposited'    # Selet energy calculation to use: 'Simple', 'Released', 'Deposited'

### Debris Cloud Coefficients
m.DCC_D = 1.5		# drag coeff.
m.DCabp = 1.2e-8		# ablation parameter
m.DCC_L = 1.e-3
m.DCC_S = 0.3
m.DCincr_strength = 'No' 	# Increasing strength after fragmentation: 'Yes' or 'No'
m.DCablation_rad = 'No'
m.DCmstrength0 = 11.e5 
m.DCenergy_calc = 'Deposited'     # Selet energy calculation to use: 'Simple', 'Released', 'Deposited'
...
### Data file names
m.datadirectory = "Data"		# location of where to sabe output data
...
print 'Running Pancake Model...'
m.RunPM( m.t0, m.tend)
print 'Running Debris Cloud Model...'
m.RunDC( m.t0, m.tend)
